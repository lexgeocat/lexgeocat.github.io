    ...
    <template #before-features>
      <div class="g g-auto" style="margin-bottom:48px">
        ...
        <div class="res-card reveal">
          ...
          <div class="res-body"><h4>Tutoriales SIG</h4><p>Material de QGIS, PostGIS y cartografía digital orientado al contexto boliviano.</p><span class="res-tag" style="background:var(--sapphire-lt);color:var(--color-esp-geomatica);border-color:var(--color-esp-geomatica-2)">GIS</span></div>
        </div>
        <div class="res-card reveal">
          <div class="res-icon" style="background:var(--sapphire-lt);color:var(--color-esp-software)"><i class="fa-solid fa-code"></i></div>
          <div class="res-body"><h4>Scripts y automatización</h4><p>Herramientas Python, AutoLISP y plantillas para agilizar flujos de trabajo GIS.</p><span class="res-tag" style="background:var(--sapphire-lt);color:var(--color-esp-software);border-color:var(--color-esp-software)">Tecnología</span></div>
        </div>
      </div>
    </template>
  </TopicPage>
