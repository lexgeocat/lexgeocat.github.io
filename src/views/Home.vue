...
<template>
  <section class="hero">
    <div class="hero-bg">
      ...
      <div class="hero-bg-fade" aria-hidden="true" />
      ...
      <div class="hero-grid">
        <div class="hero-content">
          <h1 class="hero-title">
            ...
            <span class="line-sub"
              >Derecho, Catastro y Ordenamiento Territorial, Geografía y Geomática</span
            >
          </h1>
          <p class="hero-desc">
          ...
          <div class="hero-btns">
            <router-link class="btn btn-gold" to="/pages/servicios.html">
              <i aria-hidden="true" class="fa-solid fa-briefcase" /> Ver Servicios
            </router-link>
            <a class="btn btn-ghost" :href="SITE.blog.url"
              ><i aria-hidden="true" class="fa-solid fa-newspaper" /> Explorar Blog</a
            >
          </div>
          <div class="hero-stats">
            <div class="hstat">
              <div id="stat-articulos" class="hstat-n" data-count="0">0</div>
              <div class="hstat-l">Artículos</div>
            </div>
            <div class="hstat">
              <div id="stat-especialidades" class="hstat-n" data-count="0">0</div>
              <div class="hstat-l">Especialidades</div>
            </div>
            <div class="hstat">
              <div id="stat-servicios" class="hstat-n" data-count="0">0</div>
              <div class="hstat-l">Servicios</div>
            </div>
            <div class="hstat">
              <div id="stat-recursos" class="hstat-n" data-count="0">0</div>
        ...
        <div class="hero-visual">
          <div class="floating-dashboard">
            <object class="fd-bg-map" type="image/svg+xml" :data="boliviaMap" aria-hidden="true" />
  ...
  <section id="categorias-servicios" class="sec-stripe">
    <div class="c">
      <div class="sh center">
      ...
      <div id="especialidades-grid" class="g g-auto">
        <router-link class="cat-card reveal esp-derecho" to="/pages/derecho.html">
          <i aria-hidden="true" class="fa-solid fa-scale-balanced ci" />
          ...
          <span class="cat-tag"
            ><i aria-hidden="true" class="fa-solid fa-arrow-right" /> Explorar</span
          >
        </router-link>
        <router-link class="cat-card reveal esp-catastro" to="/pages/catastro.html">
          <i aria-hidden="true" class="fa-solid fa-map ci" />
        ...
        <router-link class="cat-card reveal esp-ordenamiento" to="/pages/ordenamiento.html">
          <i aria-hidden="true" class="fa-solid fa-compass-drafting ci" />
        ...
        <router-link class="cat-card reveal esp-geografia" to="/pages/geografia.html">
          <i aria-hidden="true" class="fa-solid fa-earth-americas ci" />
        ...
        <router-link class="cat-card reveal esp-topografia" to="/pages/topogeodesia.html">
          <i aria-hidden="true" class="fa-solid fa-mountain ci" />
        ...
        <router-link class="cat-card reveal esp-geomatica" to="/pages/geomantica.html">
          <i aria-hidden="true" class="fa-solid fa-layer-group ci" />
        ...
        <router-link class="cat-card reveal esp-software" to="/pages/desarrollo-software.html">
          <i aria-hidden="true" class="fa-solid fa-code ci" />
  ...
  <section id="blog-section" class="sec-stripe">
    <div class="c">
      <div class="sh center">
      ...
      <div style="text-align: center; margin-top: 44px">
        <a class="btn btn-gold" :href="SITE.blog.url"
  ...
  <section id="recursos-servicios" class="sec-stripe">
    <div class="c">
      <div class="sh center">
      ...
      <div style="text-align: center; margin-top: 40px">
        <router-link class="btn btn-gold" to="/pages/recursos.html">
          <i aria-hidden="true" class="fa-solid fa-folder-open" /> Ver todos los recursos
        </router-link>
      </div>
    </div>
  </section>

  <section id="contacto-servicios" class="sec">
    <div class="c">
      <div class="sh center">
      ...
      <div class="contact-wrap">
        <div class="contact-info">
          ...
          <div class="contact-item">
            <div class="contact-icon">
              <i aria-hidden="true" class="fa-solid fa-location-dot" />
            </div>
          ...
          <div class="contact-item">
            <div class="contact-icon">
              <i aria-hidden="true" class="fa-solid fa-id-card" />
            </div>
            <div class="contact-text">
          ...
          <div class="contact-wa-wrap">
            <a class="btn btn-whatsapp" :href="SITE.social.whatsapp" target="_blank" rel="noopener"
              ><i aria-hidden="true" class="fa-brands fa-whatsapp" /> Escríbeme por WhatsApp</a
            >
          </div>
        </div>
        <div class="cf-form-cta">
          ...
          <router-link class="btn btn-gold" to="/pages/contacto.html">
            <i aria-hidden="true" class="fa-solid fa-envelope" /> Ir al formulario de contacto
          </router-link>
        </div>
      </div>
    </div>
