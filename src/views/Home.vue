    ...
    <div class="c">
      <div class="hero-grid">
        <div class="hero-content">
          ...
          <p class="hero-desc">
            Plataforma especializada en consultoría, recursos y formación técnica en materia legal, catastral y sistemas de información geográfica adaptados al contexto boliviano.
          </p>
          <div class="hero-btns">
            <router-link
              class="btn btn-gold"
            ...
            >
              <i class="fa-solid fa-briefcase" /> Ver Servicios
            </router-link>
            <a
              class="btn btn-ghost"
              :href="SITE.blog.url"
            ><i class="fa-solid fa-newspaper" /> Explorar Blog</a>
          </div>
  ...
  >
    <div class="c">
      <div class="sh center">
        ...
        <p class="sd">
          Siete disciplinas en la intersección del derecho, la ingeniería territorial, la geomática y el desarrollo de software aplicadas al contexto boliviano.
        </p>
      </div>
      <div
      ...
      >
        ...
        >
          <i class="fa-solid fa-scale-balanced ci" />
          <h3 class="ct">
            Derecho
          </h3>
          <p class="cd">
            Legislación boliviana, derecho civil, usucapión, derecho registral, notarial y normativa territorial aplicable a la gestión del territorio.
          </p>
          <span class="cat-tag"><i class="fa-solid fa-arrow-right" /> Explorar</span>
        </router-link>
        <router-link
          class="cat-card reveal esp-catastro"
          to="/pages/catastro.html"
        >
          <i class="fa-solid fa-map ci" />
          <h3 class="ct">
            Catastro
          </h3>
          <p class="cd">
            Registro predial, valuación fiscal, nomenclatura catastral, fichas prediales, geocodificación y sistemas de información territorial.
          </p>
          <span class="cat-tag"><i class="fa-solid fa-arrow-right" /> Explorar</span>
        </router-link>
        <router-link
        ...
        >
          <i class="fa-solid fa-compass-drafting ci" />
          <h3 class="ct">
            Ordenamiento Territorial
          </h3>
          <p class="cd">
            Planes de ordenamiento urbano y rural, zonificación, uso de suelo, normativa territorial y asesoría a gobiernos municipales.
          </p>
          <span class="cat-tag"><i class="fa-solid fa-arrow-right" /> Explorar</span>
        </router-link>
        <router-link
        ...
        >
          <i class="fa-solid fa-earth-americas ci" />
          <h3 class="ct">
            Geografía
          </h3>
          <p class="cd">
            Análisis del territorio, geografía humana, física, regional, urbana, rural y de los riesgos naturales en Bolivia.
          </p>
          <span class="cat-tag"><i class="fa-solid fa-arrow-right" /> Explorar</span>
        </router-link>
        <router-link
        ...
        >
          <i class="fa-solid fa-mountain ci" />
          <h3 class="ct">
            Topografía y Geodesia
          </h3>
          <p class="cd">
            Levantamientos topográficos, planimetría, altimetría, replanteo, posicionamiento GNSS, redes geodésicas y modelos geoidales.
          </p>
          <span class="cat-tag"><i class="fa-solid fa-arrow-right" /> Explorar</span>
        </router-link>
        <router-link
        ...
        >
          <i class="fa-solid fa-layer-group ci" />
          <h3 class="ct">
            Geomática
          </h3>
          <p class="cd">
            Sistemas de información geográfica, teledetección, cartografía digital, PostGIS/QGIS, GeoServer y análisis espacial avanzado.
          </p>
          <span class="cat-tag"><i class="fa-solid fa-arrow-right" /> Explorar</span>
        </router-link>
        <router-link
        ...
        >
          <i class="fa-solid fa-code ci" />
          <h3 class="ct">
            Desarrollo de Software y Aplicaciones Web
          </h3>
          <p class="cd">
            Aplicaciones web geográficas, bases de datos espaciales, APIs, automatización, portales institucionales y servicios públicos digitales.
          </p>
          <span class="cat-tag"><i class="fa-solid fa-arrow-right" /> Explorar</span>
        </router-link>
      </div>
  ...
  >
    <div class="c">
      <div class="sh center">
        ...
        <p class="sd">
          Análisis, guías y recursos desde la práctica profesional en derecho territorial, catastro, geomática y desarrollo de software en Bolivia.
        </p>
      </div>
      <div class="blog-grid">
        <BlogCard
  ...
  >
    <div class="c">
      ...
      <div style="text-align:center;margin-top:40px">
        ...
        >
          <i class="fa-solid fa-folder-open" /> Ver todos los recursos
        </router-link>
      </div>
    </div>
  </section>
    ...
    <div class="c">
      ...
      <div class="contact-wrap">
        <div class="contact-info">
          ...
          <div class="contact-item">
            ...
            <div class="contact-text">
              <h4>Ubicación</h4><p>Viacha, Departamento de La Paz, Bolivia</p>
            </div>
          </div>
          <div class="contact-item">
            <div class="contact-icon">
            ...
            <div class="contact-text">
              <h4>Correo Electrónico</h4><p>lexgeocat@gmail.com</p>
            </div>
          </div>
          <div class="contact-item">
            <div class="contact-icon">
          ...
          <div class="contact-wa-wrap">
            <a
              ...
              target="_blank"
              rel="noopener"
            ><i class="fa-brands fa-whatsapp" /> Escríbeme por WhatsApp</a>
          </div>
        </div>
        <div class="cf-form-cta">
          ...
          <p class="cta-email">
            <i class="fa-solid fa-envelope" /> <strong>lexgeocat@gmail.com</strong>
          </p>
          <router-link
            class="btn btn-gold"
            to="/pages/contacto.html"
          >
            <i class="fa-solid fa-envelope" /> Ir al formulario de contacto
          </router-link>
        </div>
      </div>
    </div>
