    ...
    <template #after-features>
      ...
      <div class="feature-grid">
        <div class="feature-item reveal">
          <i class="fa-solid fa-satellite" /><h3>Posicionamiento GNSS</h3><p>GPS, GLONASS, Galileo y BeiDou con precisión centimétrica (estático, RTK, PPK).</p>
        </div>
        <div class="feature-item reveal">
          <i class="fa-solid fa-globe" /><h3>Sistemas de referencia</h3><p>WGS84, SIRGAS, PSAD56 y datum oficiales del Estado Plurinacional de Bolivia.</p>
        </div>
        <div class="feature-item reveal">
          <i class="fa-solid fa-diagram-project" /><h3>Redes geodésicas</h3><p>Diseño, monumentación, observación y ajuste de puntos de control.</p>
        </div>
        <div class="feature-item reveal">
          <i class="fa-solid fa-mountain" /><h3>Modelos geoidales</h3><p>Altitudes ortométricas con EGM96, EGM2008 y modelos locales.</p>
        </div>
      </div>
